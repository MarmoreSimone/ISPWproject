...
public class DummyCLI extends viewcli.UtilsCli{
    ...
    public void launch(){
        ...
        switch (input){
            ...
            case "1":
                DAOfactory.getDAOfactory().createCafeteriaDAO().saveCafeteria(new Cafeteria("bar di ingegnieria","via del cambridge","Tor vergata","12345677","Un angolo accogliente nel cuore della città, ideale per una pausa rilassante o una chiacchierata tra amici. Offre una selezione di caffè artigianali, dolci fatti in casa e opzioni per ogni gusto, con uno staff sempre sorridente e disponibile.", "/images/baring.jpg"));
                ...
                DAOfactory.getDAOfactory().createCafeteriaDAO().saveCafeteria(new Cafeteria("bar di lettere","via del cammino","ciampino","5685868","Caffetteria di quartiere che ti fa sentire a casa, con un’atmosfera calorosa e informale. Serviamo caffè di alta qualità, tè aromatizzati e snack deliziosi, accompagnati da un sorriso e un servizio rapido.","/images/cafe3.jpg"));
                break;
